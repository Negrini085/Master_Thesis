# The main goal of this script is to inspect snow density map properties. This is
# the first time I deal with sucha variable, so making a plot could be useful.
rm(list = ls())
gc()
...
f_name <- "y2011/ITSNOW_RhoS_201103.nc"
nc <- nc_open(f_name)
lat_name = "Latitude"
lon_name = "Longitude"
swe_name = "RhoS"
...
ggplot() +
  ...
  labs(title = "Snow density 01/03/2011", x = "Longitude", y = "Latitude", fill = "Rho [kg/m^3]") +
  theme_minimal()
