# The main goal of this script is to underline los dependence on elevation. I will
# try to reproduce a graph in MODIS paper.
rm(list = ls())
gc()
...
p <- ggplot(percentile_df, aes(x = elevation, y = los_q, color = prob_lab)) +
...
#ggsave("Figures/los_vs_elevation_percentiles.png", plot = p, width = 7, height = 5.5, dpi = 300)