...
mask <- df_plot$los_STA < 1.15 * df_plot$los_MOD & df_plot$los_STA > 0.85 * df_plot$los_MOD
df_plot <- df_plot[mask, ]


# Saving df
write.table(df_plot, "Dataset/appo.dat", row.names = FALSE, col.names = TRUE, quote = FALSE)