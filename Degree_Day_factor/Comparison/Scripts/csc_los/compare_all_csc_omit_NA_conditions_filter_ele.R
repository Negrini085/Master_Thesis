...
# compare CSC derived from MODIS series and from in-situ datas for all stations. I will
# plot here CSC calculated after having filtered out those years that consisted of only 
...
fname_STA_comp     <- "../STATION_series/Datas/results/correct_with_summer_average/longest_periods_sc_compatible.dat"
fname_STA_non_comp <- "../STATION_series/Datas/results/correct_with_summer_average/longest_periods_sc_non_compatible.dat"
