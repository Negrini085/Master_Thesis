# The main goal of this script is to check if geo-data of italian aws stations 
# are indeed correct or not.
rm(list = ls())
gc()
...
write.table(results, file = "Datas/filtered.dat", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")