...
# a moderate snow coverage (between 200 and 250) according to MODIS, but almost a full
...
mask <- merged$los_MOD > 200  & merged$los_MOD < 250 & merged$los_STA > 300
...
write.table(to_analyze, "Datas/MOD250_STA300.dat", row.names = FALSE, col.names = FALSE, quote = FALSE)