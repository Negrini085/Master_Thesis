...
appo <- as.matrix(read.table("STATION_check/Correcting/correcting_dataset.dat", header = FALSE))
...
write.table(results, file = "STATION_check/Correcting/now.dat", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")