...
appo <- as.matrix(read.table("CHECK_stations/Correcting/correcting_dataset.dat", header = FALSE))
...
write.table(results, file = "CHECK_stations/Correcting/now.dat", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")