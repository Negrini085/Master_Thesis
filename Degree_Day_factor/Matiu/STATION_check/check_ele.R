...
appo <- as.matrix(read.table("Dataset/data/ANAGRAFICA_ITA", header = FALSE))
...
write.table(results, file = "Dataset/checked_ele_ita.dat", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")