# The main goal of this script is to plot italian AWS to check if those are actually
# inside italian borders or not.
rm(list = ls())
gc()
...
appo <- read.table("Datas/ITALIAN_STATIONS", header = FALSE)
