...
month_map <- rowSums(sc, dims = 2L, na.rm = TRUE)
month_map[is.na(dem)] <- NA
...
ggplot() +
  ...
  labs(title = "Snow cover duration March 2011", x = "Longitude", y = "Latitude", fill = "") +
  theme_minimal()
