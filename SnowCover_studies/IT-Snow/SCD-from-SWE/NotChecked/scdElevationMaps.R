...
year <- 2025
fname <- paste0("Datas/meanSCD_elevationMaps.nc")

nc <- nc_open(fname)
lat <- ncvar_get(nc, "lat") 
lon <- ncvar_get(nc, "lon") 
print(names(nc$dim))
bands <- ncvar_get(nc, "bands")
...
titles <- c(
  ...
  "2000 - 2500 m", "2500 - 3000 m", "3000 - 3500 m", "3500 - 4000 m",
  "4000 - 5000 m"
)
...
panel_grid <- arrangeGrob(grobs = plots_noleg, nrow = 3, ncol = 3) 
